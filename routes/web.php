...
// --- RUTAS PÚBLICAS DE JUEGOS ---
Route::get('/games', [GameController::class, 'index'])->name('games.index');

// IMPORTANTE: Esta ruta debe ir antes de {slug} para que no la confunda con un juego
Route::get('/games/search/json', [GameController::class, 'searchJson'])->name('games.searchJson'); 

// Usamos {slug} en vez de {game:slug} para permitir juegos de la API que no están en BD
...
Route::middleware('auth')->group(function () {
    ...
    // Acciones de Juego (Usamos {slug} para todas)
    ...
    // Perfil y Social
    // NOTA: setFavorite debe apuntar a UserController si ahí pusiste la lógica
    Route::post('/profile/favorite', [UserController::class, 'setFavorite'])->name('profile.setFavorite'); 
