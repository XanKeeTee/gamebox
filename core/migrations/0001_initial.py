# Generated by Django 6.0.4 on 2026-05-03 20:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('backlog', 'Backlog'), ('playing', 'Jugando'), ('completed', 'Completado'), ('dropped', 'Abandonado'), ('100_percent', 'Platinado')], default='backlog', max_length=20)),
            ...
            options={
                'indexes': [models.Index(fields=['user', 'status'], name='core_playlo_user_id_623a07_idx')],
