        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                ...
                <form action="{{ route('games.index') }}" method="GET" class="w-full md:w-96 relative">
                    <input type="text" name="q" value="{{ request('q') }}" placeholder="Buscar título..." 
                           class="w-full bg-[#20242c] border border-gray-700 text-white rounded-full py-2 pl-4 pr-10 focus:ring-green-500 outline-none">
            ...
            <div class="bg-[#20242c] p-4 rounded-lg border border-gray-800 mb-6 flex flex-wrap gap-4 items-center">
                ...
                <form id="filterForm" action="{{ route('games.index') }}" method="GET" class="flex flex-wrap gap-2">
                    ...
                    <select name="genre" onchange="this.form.submit()" class="bg-[#14181c] border border-gray-600 text-sm text-gray-300 rounded px-3 py-1.5 outline-none">
                    ...
                    <select name="platform" onchange="this.form.submit()" class="bg-[#14181c] border border-gray-600 text-sm text-gray-300 rounded px-3 py-1.5 outline-none">
